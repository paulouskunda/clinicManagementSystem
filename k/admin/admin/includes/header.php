...
<head>
	...
	<meta charset="utf-8">
	<meta name="description" content="Bootstrap Metro Dashboard For ZedHipHop">
	<meta name="author" content="Paulous Studio">

	<meta name="viewport" content="width=device-width, initial-scale=1">
	<title>ZedHipHop Administrator Panel </title>
	<script type="text/javascript">
	function confirmDel()
	{
		var x = confirm("You are about to delete the selected profile, are you sure?");
