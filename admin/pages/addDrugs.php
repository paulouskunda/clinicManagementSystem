                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Add Drugs</h2>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form-group" action="filesAdded.php" method="POST">
                                        ...
                                        <br>
                                        <br><br>
                                        <input type="submit" name="drugsSubmit" value="Add Drugs" class="form-control btn btn-primary" style="width: 20%;">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            Copyright © 2018 SUMBU. All rights reserved. Dashboard by <a href="https:// .com/wp/"> </a>.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
